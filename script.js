...
// // Using the "reduce" method to group the elements in the array
// const groupedReduce = array.reduce((acc, currentValue) => {
//   // establish the key based on whether the current value is even or odd
//   const key = currentValue % 2 === 0 ? "even" : "odd";

//   //If the key is not present in the accumulator, set it up as an empty array.
//   if (!acc[key]) {
//     acc[key] = [];
//   }

//   // push the current value in the corresponding group
...
// console.log(groupedReduce); // output{ odd:[1,3,5], even:[2,4,6]}

// //Using the "Object.groupBy" method to group the elements in the array

// const groupedBy = Object.groupBy(array, (each) => {
